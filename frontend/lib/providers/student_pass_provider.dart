        ...
        passes.add(
          pass["status"] == "Used"
              ? Pass(
                  ...
                  actualInTime:
                      "${TimeOfDay.fromDateTime(DateTime.parse(pass['entryScanAt'])).hourOfPeriod}:${TimeOfDay.fromDateTime(DateTime.parse(pass['entryScanAt'])).minute.toString().padLeft(2, '0')} ${TimeOfDay.fromDateTime(DateTime.parse(pass['entryScanAt'])).period.name.toUpperCase()}",
                  actualOutDate:
    ...
    try {
      ...
      state = [
        ...
        Pass(
          ...
          expectedOutTime:
              "${outTime.hourOfPeriod}:${outTime.minute.toString().padLeft(2, '0')} ${outTime.period.name}",
